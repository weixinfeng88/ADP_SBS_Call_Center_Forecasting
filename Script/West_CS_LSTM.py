...
for month_number in ['2024-11-15','2024-12-15','2025-01-15','2025-02-15','2025-03-15']:
    #ETL Process
    data = pd.read_excel('workspace/West_WFM_STAT_2025_05_16.xlsx')
    ...
    all_predict.to_excel(r'workspace/West_CS_Test_05_17_{}.xlsx'.format(month_number))
    time_ = []
    ...
    all_feature.to_excel(r'workspace/West_CS_Target_05_17_{}.xlsx'.format(month_number))