...
for month_number in ['2024-01-15']:
#for month_number in ['2024-11-15','2024-12-15','2025-01-15','2025-02-15','2025-03-15']:
    ...
    all_predict.to_excel(r'workspace/MidWest_CS_Test_{}.xlsx'.format(month_number))
    time_ = []
    ...
    all_feature.to_excel(r'workspace/MidWest_CS_Target_{}.xlsx'.format(month_number))